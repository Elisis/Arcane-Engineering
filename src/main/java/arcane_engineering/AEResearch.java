...
public class AEResearch
{
    ...
    public static void registerResearch() {
        ...
        pages = new ResearchPage[] { new ResearchPage("ArcaneEngineering.research_page.DRILLTHAUMIUM"), new ResearchPage((ShapedArcaneRecipe) AEResearch.recipes.get(1)) };
        ...
        pages = new ResearchPage[] { new ResearchPage("ArcaneEngineering.research_page.DRILLVOID"), new ResearchPage((InfusionRecipe) AEResearch.recipes.get(2)) };
        ...
        pages = new ResearchPage[] { new ResearchPage("ArcaneEngineering.research_page.NODEDESTABILIZER"), new ResearchPage(new IArcaneRecipe[] { (IArcaneRecipe) AEResearch.recipes.get(0) }) };
        ...
        pages = new ResearchPage[] { new ResearchPage("ArcaneEngineering.research_page.CAP_steel"), new ResearchPage(new IArcaneRecipe[] { (IArcaneRecipe) AEResearch.recipes.get(3) }) };
        ...
        pages = new ResearchPage[] { new ResearchPage("ArcaneEngineering.research_page.CAP_electrum"), new ResearchPage(new IArcaneRecipe[] { (IArcaneRecipe) AEResearch.recipes.get(4) }) };
        ...
        pages = new ResearchPage[] { new ResearchPage("ArcaneEngineering.research_page.CAPACITOR"), new ResearchPage(new IArcaneRecipe[] { (IArcaneRecipe) AEResearch.recipes.get(5) }) };
        ...
        pages = new ResearchPage[] { new ResearchPage("ArcaneEngineering.research_page.CHARGER"), new ResearchPage((InfusionRecipe) AEResearch.recipes.get(6)) };
        ...
        pages = new ResearchPage[] { new ResearchPage("ArcaneEngineering.research_page.ENERGIZER"), new ResearchPage((InfusionRecipe) AEResearch.recipes.get(7)) };
